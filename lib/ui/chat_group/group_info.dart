...
class _GroupInfoState extends State<GroupInfo> {
  ...
  getMembers() async {
    FireStoreRepository(uid: FirebaseAuth.instance.currentUser!.uid).getGroupMembers(widget.groupId).then((val){
      setState(() {
        members = val;
      });
    });
              ...
              return AlertDialog(
                ...
                actions: [
                  ...
                  IconButton(onPressed: () async {
                    FireStoreRepository(uid: FirebaseAuth.instance.currentUser!.uid).toggleGroupJoin(widget.groupId, getName(widget.adminName) , widget.groupName,).whenComplete((){
